...
#import "ProjectsVC.h"
@interface MemberInfoViewController ()<SWRevealViewControllerDelegate>
{
...
- (void)viewDidLoad {
    ...
    [self makePostCallForPage:EMPLOYEEDETIALS withParams:@{@"employee_id":_member_Id} withRequestCode:12];
